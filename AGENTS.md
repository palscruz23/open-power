...
- Arc-flash frontend annotations should cover the selected study bus plus any directly connected equipment nodes so the canvas shows the affected location without inventing a second persisted equipment-selection model.
